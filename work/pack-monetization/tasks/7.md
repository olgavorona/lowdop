...
Delete -- this is a UI view. Verification is via build success and visual inspection. No unit-testable logic is being introduced (the purchase logic lives in SubscriptionManager, tested in task 5). The security-critical parental gate is a separate view (ParentalGateView.swift) unchanged by this task.
