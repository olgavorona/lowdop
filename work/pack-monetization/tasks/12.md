...
```bash
grep -rn 'case easy' LowDopamineLabyrinth/LowDopamineLabyrinth/ --include='*.swift' | head -5
# Expected: matches in UserPreferences.swift (DifficultyLevel enum)
grep -rc 'case beginner\|case expert' LowDopamineLabyrinth/LowDopamineLabyrinth/ --include='*.swift'
# Expected: 0 matches
```
...
```bash
grep -rl 'totalFreeLabyrinthsPlayed\|dailyLabyrinthsPlayed\|canPlayToday\|freeLabyrinthsRemaining' LowDopamineLabyrinth/LowDopamineLabyrinth/ --include='*.swift' 2>/dev/null | wc -l
# Expected: 0
```
...
```bash
grep -rl 'labyrinth_unlimited_weekly\|labyrinth_unlimited_monthly\|labyrinth_unlimited_yearly\|labyrinth_unlimited_lifetime' LowDopamineLabyrinth/LowDopamineLabyrinth/ --include='*.swift' 2>/dev/null | wc -l
# Expected: 0
```
...
```bash
grep -r 'labyrinth_pack_ocean' LowDopamineLabyrinth/LowDopamineLabyrinth/ --include='*.swift'
...
```bash
ls LowDopamineLabyrinth/LowDopamineLabyrinth/Views/BookshelfView.swift
